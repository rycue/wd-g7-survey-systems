...
function allReadinessAnswered() {
    const groups = ['r_doc','r_meet','r_evac','r_contacts','r_map','r_alert'];
    return groups.every(g => document.querySelector(`input[name="${g}"]:checked`));
}
...
form.addEventListener('submit', function(e) {
  ...
  document.getElementById('err-waste').style.display = wasteagree ? 'none' : 'block';
